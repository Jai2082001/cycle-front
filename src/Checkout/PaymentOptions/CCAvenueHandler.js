const CCAvenueHandler = (merchantid, amount, orderid, billing, shipping, customerid) => {
    return (
		...
		<table width="40%" height="100" border='1' align="center">
			...
			<tr>
				<td>Merchant Id</td>
				<td><input type="text" name="merchant_id" id="merchant_id" value="2006890" /> </td>
			</tr>
			<tr>
				<td>Order Id</td>
			...
			<tr>
				<td>Customer Id:</td>
				<td><input type="text" name="customer_identifier" value="20"/></td>
			</tr>
			<tr>
				<td></td>
...
export default CCAvenueHandler;